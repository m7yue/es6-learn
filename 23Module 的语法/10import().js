...
// 注意点
// import()加载模块成功以后，这个模块会作为一个对象，当作then方法的参数。因此，可以使用对象解构赋值的语法，获取输出接口。@I
import('./myModule.js.js')
.then(({export1, export2}) => {
  // ...·
});

// 如果模块有default输出接口，可以用参数直接获得。 @I
import('./myModule.js.js')
.then(myModule => {
...
// 如果想同时加载多个模块，可以采用下面的写法。 @I
Promise.all([
  import('./module1.js.js'),
  import('./module2.js.js'),
  import('./module3.js.js'),
])
...
async function main() {
  const myModule = await import('./myModule.js.js');
  const {export1, export2} = await import('./myModule.js.js');
